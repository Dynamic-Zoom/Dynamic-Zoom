...
class SwiftSRGAN2x(Generator):
    def __init__(
        self, in_channels: int = 3, num_channels: int = 64, num_blocks: int = 16
    ):
        super().__init__(in_channels, num_channels, num_blocks, upscale_factor=2)
...
class SwiftSRGAN4x(Generator):
    def __init__(
        self, in_channels: int = 3, num_channels: int = 64, num_blocks: int = 16
    ):
        super().__init__(in_channels, num_channels, num_blocks, upscale_factor=4)
